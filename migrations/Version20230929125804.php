 ...
 */
final class Version20230929125804 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE addresses ADD CONSTRAINT FK_6FCA751638B53C32 FOREIGN KEY (company_id_id) REFERENCES companies (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
