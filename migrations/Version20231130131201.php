 ...
 */
final class Version20231130131201 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tax_rates (id INT NOT NULL, invoice_lines_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, rate INT NOT NULL, for_sales TINYINT(1) NOT NULL, for_purchases TINYINT(1) NOT NULL, accounting_code_collected LONGTEXT DEFAULT NULL, accounting_code_deductible LONGTEXT DEFAULT NULL, is_expenses_intracommunity_tax_rate TINYINT(1) NOT NULL, INDEX IDX_F7AE5E1D60C6BCB4 (invoice_lines_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
