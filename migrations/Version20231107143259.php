 ...
 */
final class Version20231107143259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE expense_lines (id INT AUTO_INCREMENT NOT NULL, expenses_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, quantity INT NOT NULL, total_pre_tax_amount DOUBLE PRECISION NOT NULL, accounting_code VARCHAR(255) DEFAULT NULL, INDEX IDX_EC092BAC2055804A (expenses_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
