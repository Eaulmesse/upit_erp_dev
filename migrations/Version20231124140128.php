 ...
 */
final class Version20231124140128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contracts (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, company_id INT DEFAULT NULL, name LONGTEXT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, comments LONGTEXT DEFAULT NULL, expected_delivery_date DATETIME DEFAULT NULL, company_name VARCHAR(255) NOT NULL, contact_name VARCHAR(255) NOT NULL, street LONGTEXT NOT NULL, zip_code INT NOT NULL, city LONGTEXT NOT NULL, region LONGTEXT DEFAULT NULL, country LONGTEXT NOT NULL, first_invoice_planned_date DATETIME DEFAULT NULL, generate_and_send_recurring_invoices LONGTEXT DEFAULT NULL, invoice_frenquency_in_months LONGTEXT DEFAULT NULL, preauthorized_debit LONGTEXT DEFAULT NULL, last_update_date DATETIME DEFAULT NULL, invoice_address_street VARCHAR(255) NOT NULL, invoice_address_city VARCHAR(255) NOT NULL, delivery_address_street VARCHAR(255) DEFAULT NULL, delivery_address_city VARCHAR(255) DEFAULT NULL, INDEX IDX_950A973A76ED395 (user_id), INDEX IDX_950A973979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tax_rates CHANGE id id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tax_rates CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
}
